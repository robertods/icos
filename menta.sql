...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-10-2014 a las 03:41:39
...
(1, 'heladera nueva', 'test1', 'heladera nueva de fabrica', 'heladera', NULL, 1, 'heladera', 0, '2014-10-12 19:07:38', 6),
(2, 'test2', 'test2', 'mochila roja', 'test2', NULL, 1, 'mochila', 0, '2014-10-12 19:07:38', 8),
(3, 'test3', 'test3', 'd3', 'test3', NULL, 1, 'reloj', 1, '2014-10-12 19:09:13', 8),
...
(1, 'marcelapanasia', 'marchi_7_8@hotmail.com', 'ef73781effc5774100f87fe2f437a435', 'ecf2653513242230337ba1f1b14bbfa32309c6b4', '2014-10-17 13:59:52');
...
--
ALTER TABLE `lista_producto_propuesto`
MODIFY `id_lista_producto_propuesto` int(11) NOT NULL AUTO_INCREMENT;
--
