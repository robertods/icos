			...
			*/
			...
			switch($datos[0]){
				...
				case 'procesar-edicion':
					...
					if($resultado){						
						header("location: ../mensaje/edicion-usuario-ok:{$_POST['id_usuario']}");
					}else{
						header("location: ../mensaje/edicion-usuario-error:{$_POST['id_usuario']}");
					}	
				...
				case 'eliminar':
					...
					if($resultado){
						header("location: ../mensaje/borrado-usuario-ok:{$datos[1]}");
					}else{
						header("location: ../mensaje/borrado-usuario-error:{$datos[1]}");
					}	
